...
def tick(tim):                # we will receive the timer object when being called0
    global timercount
    timercount -= 1
    if timercount <= 0:
        timercount = baseTime
