...
def runTimer(tim):
    ...
    tim.init(period=100,mode=Timer.ONE_SHOT ,callback=runTimer)

def delayMs(t):
    if isRUN:
        time.sleep_ms(t)       #延时等待10毫秒,1000毫秒=1秒
    return
...
def main():
    ...
    while True:
        if isRUN:
            ...
            delayMs(2000)       #延时等待10毫秒,1000毫秒=1秒
            ...
            delayMs(3000)       #延时等待10毫秒,1000毫秒=1秒
            for i in range(3):       
                touchOncePin(7)          #j7点击一次
                delayMs(1000)       #延时等待10毫秒,1000毫秒=1秒
            for i in range(3):       
                touchOncePin(8)          #j7点击一次
                delayMs(1000)       #延时等待10毫秒,1000毫秒=1秒
            delayMs(3000)       #延时等待10毫秒,1000毫秒=1秒
            touchOncePin(9)          #j8点击一次
            delayMs(2000)       #延时等待10毫秒,1000毫秒=1秒
        time.sleep_ms(100)
